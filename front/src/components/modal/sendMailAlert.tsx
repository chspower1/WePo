    ...
    return(
        <Wrapper>
            <Modal>
                ...
                <ModalHeader><AccentWord>인증메일</AccentWord>을 보내드렸어요.</ModalHeader>
                <ModalHeader><AccentWord>인증메일</AccentWord>을 확인해주세요.✉️</ModalHeader>
                </div>
                <ModalMsgBox>
                    <ModalMsg>반가워요 WEPO에 오신것을 환영합니다!😆😆 </ModalMsg>
                    <ModalMsg>아직 한 단계가 남아있습니다.</ModalMsg>
                    <ModalMsg>가입하신 이메일을 인증해주시면, WEPO의 서비스를 마음껏 이용하실 수 있습니다.</ModalMsg>
                    <ModalMsg>👍🏻가입해주셔서 감사합니다👍🏻</ModalMsg>
                </ModalMsgBox>
                <ModalCloseButton onClick={()=>{setSendEmail(false); navigator("/login", { replace: true });}}>로그인 페이지로 돌아가기</ModalCloseButton>
            </Modal>
        </Wrapper>
    )
}
