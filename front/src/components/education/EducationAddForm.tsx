...
export default function EducationAddForm({ educations, setEducations, setAddFormActive, id }: any) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onvalid = (data: IEducation) => {
        ...
        //curUser의 educations 추가
        // setCurUser((prev: any) => {
        //     const newCurUser = { ...prev };
        //     const newEducations: IEducation = newCurUser?.educations!;
        //     newEducations.push(educations);
        //     newCurUser.educations = newEducations;
